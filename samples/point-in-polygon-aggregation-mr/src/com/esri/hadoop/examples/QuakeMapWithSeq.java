...
public class QuakeMapWithSeq extends Mapper<Text, QuakeWritable, Text, IntWritable> {
	...
	@Override
	public void map(Text key, QuakeWritable val, Context context)
			throws IOException, InterruptedException {

		//String line = val.toString();
		//String [] values = line.split(",");
		
		Point point = (Point)(val.getLoc().getGeom().getEsriGeometry());
